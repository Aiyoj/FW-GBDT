...
cdef class Criterion:
    ...
    cdef int init(self, DOUBLE_t* y, SIZE_t y_stride, DOUBLE_t* sample_weight,
                  DOUBLE_t* feature_weight, double weighted_n_samples,
        ...
        feature_weight : array-like, dtype=DOUBLE_t
    ...
    # added
    cdef int update_current_feature_weight(self, SIZE_t feature_pos) nogil except -1:
        # feature weight 不为空, 否则默认为1.0
        if self.feature_weight != NULL:
            self.current_feature_weight = self.feature_weight[feature_pos]
    ...
    cdef double proxy_impurity_improvement(self) nogil:
        ...
        # added
        cdef double cfw = self.current_feature_weight
        self.children_impurity(&impurity_left, &impurity_right)

        return cfw * (- self.weighted_n_right * impurity_right
    ...
    cdef double impurity_improvement(self, double impurity) nogil:
        ...
        return cfw * ((self.weighted_n_node_samples / self.weighted_n_samples) *
...
cdef class RegressionCriterion(Criterion):
    ...
    def __cinit__(self, SIZE_t n_outputs, SIZE_t n_samples):
        ...
        self.current_feature_weight = 1.0
...
cdef class MSE(RegressionCriterion):
    ...
    cdef double proxy_impurity_improvement(self) nogil:
        ...
        return cfw * (proxy_impurity_left / self.weighted_n_left +
...
cdef class FriedmanMSE(MSE):
    ...
    cdef double proxy_impurity_improvement(self) nogil:
        ...
        return cfw * diff * diff / (self.weighted_n_left * self.weighted_n_right)
...
cdef class ClassificationCriterion(Criterion):
    ...
    cdef int init(self, DOUBLE_t* y, SIZE_t y_stride,
        ...
        sample_weight : array-like, dtype=DTYPE_t
            The weight of each sample
        feature_weight : array-like, dtype=DTYPE_t
            The weight of each feature
